...
function ClientInput() {
  ...
  function getData() {
    axios
      .post("http://143.244.140.179:5000/clients/get", {
        user_id: currentUser,
        client_id: id,
      })
      .then((res) => {
        console.log(res.data.total[0]);
        formik.setFieldValue("companyName", res.data.total[0].company);
        formik.setFieldValue("companyPhoneNo", res.data.total[0].phone);
        formik.setFieldValue("clientEmail", res.data.total[0].email);
        setClientGstSchemes(res.data.total[0].gst_scheme);
        formik.setFieldValue("clientGstIn", res.data.total[0].gstin);
        formik.setFieldValue("clientPan", res.data.total[0].pan);
        formik.setFieldValue("clientVat", res.data.total[0].vat);
        formik.setFieldValue("clientWebsite", res.data.total[0].website);

        const contactInfo = res.data.total[0].contacts;
        // if (contactInfo) {
        ...
        //   });
        // }
        const address1 = res.data.total[0].address_address;
        if (address1) {
  ...
  async function onSubmitt() {
    ...
    axios
      .post("http://143.244.140.179:5000/clients/new", {
        user_id: currentUser,
        client_id: "client" + formik.values.companyPhoneNo,
  ...
  return (
    <div className="clientedit">
      <div className="itemsedit-name">New Client</div>
      <hr />
